...
class SubscriptionPackage(models.Model):
    ...
    reference_code = fields.Char(string='Membership Id',
    ...
    def action_subscription_id_card(self):
        ...
        action = self.env.ref('subscription_package.action_report_subscription_card').report_action(
            None, data=data)
    ...
    @api.model
    def check_next_invoice_date(self):
        for rec in self:
